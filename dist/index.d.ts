declare module "utils" {
    ...
    export function first(arr: readonly any[]): any;
    export function last(arr: readonly any[]): any;
    export function isPrimitive(obj: any): boolean;
    export function deepEqual(obj1: any, obj2: any): boolean;
}
declare module "index" {
    export function multik<S, R, T1>(selectorFn: (arg1: T1) => S, ...predicateAsAction: Array<[predicateValue: S, action: (selector: S, arg1: T1) => R] | [predicateOr: S[], action: (selector: S, arg1: T1) => R] | [
        predicate: (selector: S, arg1: T1) => boolean,
        action: (selector: S, arg1: T1) => R
    ] | [action: (selector: S, arg1: T1) => R]>): (arg1: T1) => R;
    export function multik<S, R, T1, T2>(selectorFn: (arg1: T1, arg2: T2) => S, ...predicateAsAction: Array<[predicateValue: S, action: (selector: S, arg1: T1, arg2: T2) => R] | [predicateOr: S[], action: (selector: S, arg1: T1, arg2: T2) => R] | [
    ...
    export function multik<S, R, T1, T2, T3>(selectorFn: (arg1: T1, arg2: T2, arg3: T3) => S, ...predicateAsAction: Array<[predicateValue: S, action: (selector: S, arg1: T1, arg2: T2, arg3: T3) => R] | [predicateOr: S[], action: (selector: S, arg1: T1, arg2: T2, arg3: T3) => R] | [
    ...
    export function multik<S, R, T1, T2, T3, T4>(selectorFn: (arg1: T1, arg2: T2, arg3: T3, arg4: T4) => S, ...predicateAsAction: Array<[
        predicateValue: S,
    ...
    export function multik<S, R, T1, T2, T3, T4, T5>(selectorFn: (arg1: T1, arg2: T2, arg3: T3, arg4: T4, arg5: T5) => S, ...predicateAsAction: Array<[
        predicateValue: S,
    ...
    export function multik<S, R, T1, T2, T3, T4, T5, T6>(selectorFn: (arg1: T1, arg2: T2, arg3: T3, arg4: T4, arg5: T5, arg6: T6) => S, ...predicateAsAction: Array<[
        predicateValue: S,
    ...
    export function multik<S, R, T1, T2, T3, T4, T5, T6, T7>(selectorFn: (arg1: T1, arg2: T2, arg3: T3, arg4: T4, arg5: T5, arg6: T6, arg7: T7) => S, ...predicateAsAction: Array<[
        predicateValue: S,
    ...
    export function multik<S, R, T1, T2, T3, T4, T5, T6, T7, T8>(selectorFn: (arg1: T1, arg2: T2, arg3: T3, arg4: T4, arg5: T5, arg6: T6, arg7: T7, arg8: T8) => S, ...predicateAsAction: Array<[
        predicateValue: S,
